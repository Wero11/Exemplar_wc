...
// Added by jch
$of_options[] = array( "name" => "Announcement",
					"type" => "heading");

$of_options[] = array( "name" => "Active",
					"desc" => "Activate the announcement.",
					"id" => "announcement_activate",
					"std" => 0,
					"type" => "checkbox");

$of_options[] = array( "name" => "Announcement Text",
					"desc" => "",
					"id" => "announcement_text",
					"std" => "",
					"type" => "text");

$of_options[] = array( "name" =>  "Announcement Font Color",
					"desc" => "",
					"id" => "announcement_font_color",
					"std" => "#333333",
					"type" => "color");

$of_options[] = array( "name" =>  "Announcement Background color",
					"desc" => "",
					"id" => "announcement_background_color",
					"std" => "#333333",
					"type" => "color");

$of_options[] = array( "name" => "News Options",
					"type" => "heading");

$of_options[] = array( "name" => "Sidebar Position",
					"desc" => "News listings page sidebar position",
