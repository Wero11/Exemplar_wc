...
<head>
	...
	#small-nav{background:<?php echo $data['primary_color']; ?> !important;}
	#megaMenu ul.megaMenu > li.menu-item > a{background:<?php echo $data['primary_color']; ?> !important; border-top:2px solid <?php echo $data['primary_color']; ?> }
	.side-nav li.current_page_item a{
	...
	.progress-bar-content,
	.pagination .current,
	.header-v3 .header-social,.header-v4 .header-social,.header-v5 .header-social, .search-btn{
	...
	<?php endif; ?>
	.announcement-wrapper {background-color:<?php echo $data['primary_color']; ?> !important;}
	.tribe-events-has-events a{background-color:<?php echo $data['image_gradient_top_color']; ?>; color:#666666; }
	.tribe-events-has-events a:hover{background-color:<?php echo $data['primary_color']; ?> !important; color:#FEFEFE !important; text-shadow:none;}
	.tribe-mini-calendar-today a, .tribe-mini-calendar-today, .tribe-mini-calendar-today .tribe-mini-calendar-no-event {background:<?php echo $data['primary_color']; ?> !important; color:#FEFEFE !important; text-shadow:none;}
	table.em-calendar td.eventful, table.em-calendar td.eventful a{background-color:<?php echo $data['image_gradient_top_color']; ?> }
	table.em-calendar td.eventless-today, table.em-calendar td.eventless-today a, table.em-calendar td.eventful-today, table.em-calendar td.eventful-today a{background-color:<?php echo $data['primary_color']; ?> }
	...
	#sliders-container .continue.button,
	...
	#sliders-container .button:hover,
	#sliders-container .continue.button:hover,
	...
	<?php endif; ?>
	.gf_page_steps .gf_step_active{color:<?php echo $data['primary_color']; ?>!important}
	<?php
	...
	.megaMenu li a{font-size:<?php echo $data['nav_font_size']; ?>px !important;}
	<?php endif; ?>
...
<body <?php body_class(); ?>>
	...
	<?php if($c_pageID == -9999) :?>
	<div class="page-title-container">
		<div class="page-title">
			<div class="page-title-wrapper">
			<h1><?php echo __("Events", "Exemplar") ?></h1>
	...
	<div class="page-title-container">
		<div class="page-title">
			<div class="page-title-wrapper">
			<h1><?php echo __('Search results for:', 'Exemplar'); ?> <?php echo get_search_query(); ?></h1>
			<?php get_search_form(); ?>
			</div>
		</div>
	</div>
	...
	<div class="page-title-container">
		<div class="page-title">
			<div class="page-title-wrapper">
			<h1><?php echo __('Error 404 Page', 'Exemplar'); ?></h1>
			</div>
		</div>
	</div>
	<?php endif; ?>
	...
	<div class="page-title-container">
		<div class="page-title">
			...
			<h1>
				<?php if ( is_day() ) : ?>
					<?php printf( __( 'Daily Archives: %s', 'Exemplar' ), '<span>' . get_the_date() . '</span>' ); ?>
				<?php elseif ( is_month() ) : ?>
					<?php printf( __( 'Monthly Archives: %s', 'Exemplar' ), '<span>' . get_the_date( _x( 'F Y', 'monthly archives date format', 'Exemplar' ) ) . '</span>' ); ?>
				<?php elseif ( is_year() ) : ?>
					<?php printf( __( 'Yearly Archives: %s', 'Exemplar' ), '<span>' . get_the_date( _x( 'Y', 'yearly archives date format', 'Exemplar' ) ) . '</span>' ); ?>
				<?php elseif(is_post_type_archive("avada_news")) : ?>
					<?php echo __("Latest News", "Exemplar"); ?>
				<?php elseif(is_post_type_archive("avada_blog")) : ?>
					<?php echo __("Blogs", "Exemplar"); ?>
				<?php else : ?>
