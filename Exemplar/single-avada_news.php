		...
		<div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
			...
			<div class="single-navigation clearfix">
				<div class="backtolist">
					<a href="<?php echo get_bloginfo("url")?>/news"><?php echo __("Back to Latest News", "Exemplar")?></a>
				</div>
				<?php previous_post_link('%link', __('Previous News Item', 'Exemplar')); ?>
				<?php next_post_link('%link', __('Next News Item', 'Exemplar')); ?>
			</div>
