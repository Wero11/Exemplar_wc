<?php get_header(); ?>
	...
	<div id="content" class="full-width portfolio-<?php echo $portfolio_width; ?>">
		...
		<div class="single-navigation clearfix">
			<?php
			if($portfolioID) {
				$previous_post_link = previous_post_link_plus(array('format' => '%link', 'link' => __('Previous', 'Exemplar'), 'in_same_tax' => 'portfolio_category', 'in_cats' => $nav_categories, 'return' => 'href'));
			} else {
				$previous_post_link = previous_post_link_plus(array('format' => '%link', 'link' => __('Previous', 'Exemplar'), 'return' => 'href'));
			}
			?>
			...
			?>
			<a href="<?php echo $previous_post_link; ?>" rel="prev"><?php _e('Previous', 'Exemplar'); ?></a>
			<?php endif; ?>
			<?php 
			if($portfolioID) {
				$next_post_link = next_post_link_plus(array('format' => '%link', 'link' => __('Next', 'Exemplar'), 'in_same_tax' => 'portfolio_category', 'in_cats' => $nav_categories, 'return' => 'href'));
			} else {
				$next_post_link = next_post_link_plus(array('format' => '%link', 'link' => __('Next', 'Exemplar'), 'return' => 'href'));				
			}
			?>
			...
			?>
			<a href="<?php echo $next_post_link; ?>" rel="next"><?php _e('Next', 'Exemplar'); ?></a>
			<?php endif; ?>
		</div>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="related-posts related-projects">
				<div class="title"><h2><?php echo __('Related Projects', 'Exemplar'); ?></h2></div>
