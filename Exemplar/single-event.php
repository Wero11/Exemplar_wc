		...
		<div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
			...
			<div class="single-navigation clearfix">
				<div class="backtolist">
					<a href="<?php echo get_bloginfo("url")?>/calendar"><?php echo __("Back to upcoming events list", "Exemplar")?></a>
				</div>
				<?php previous_post_link('%link', __('Previous Event', 'Exemplar')); ?>
				<?php next_post_link('%link', __('Next Event', 'Exemplar')); ?>
			</div>
