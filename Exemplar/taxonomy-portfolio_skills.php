		...
		<div class="portfolio-wrapper">
			...
			<div class="portfolio-item <?php echo $item_classes; ?>">
				...
				<div class="portfolio-content">
					...
					?>
					<div class="buttons">
						<a href="<?php the_permalink(); ?>" class="green button small"><?php echo __('Learn More', 'Exemplar'); ?></a>
						<?php if(get_post_meta($post->ID, 'pyre_project_url', true)): ?>
						<a href="<?php echo get_post_meta($post->ID, 'pyre_project_url', true); ?>" class="green button small"><?php echo __('View Project', 'Exemplar'); ?></a>
						<?php endif; ?>
					</div>
				</div>
			</div>
