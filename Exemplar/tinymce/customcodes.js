    ...
    tinymce.create('tinymce.plugins.tagline_box', {  
        init : function(ed, url) {  
            ed.addButton('tagline_box', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[tagline_box type="e.g. 1 or 2" link="http://themeforest.net/user/ThemeFusion" linktarget="" button="Purchase Now" title="Avada is incredibly responsive, with a refreshingly clean design" description="And it has some awesome features, premium sliders, unlimited colors, advanced theme options and so much more!"][/tagline_box]');  
    ...
    tinymce.create('tinymce.plugins.recent_posts', {  
        init : function(ed, url) {  
            ed.addButton('recent_posts', {  
                ...
                onclick : function() {  
                     ed.selection.setContent('[recent_posts columns="3 or 4" number_posts="4" cat_slug="" post_type="" thumbnail="yes" title="yes" meta="yes" excerpt="yes" excerpt_words="15" strip_html="true"][/recent_posts]');
