...
class Contact_Info_Widget extends WP_Widget {
	...
	function Contact_Info_Widget()
	{
		...
		$this->WP_Widget('contact_info-widget', 'JadeCreative: Contact Info', $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		<p class="phone"><?php _e('Phone:', 'Exemplar'); ?> <?php echo $instance['phone']; ?></p>
		<?php endif; ?>

		<?php if($instance['fax']): ?>
		<p class="fax"><?php _e('Fax:', 'Exemplar'); ?> <?php echo $instance['fax']; ?></p>
		<?php endif; ?>

		<?php if($instance['email']): ?>
		<p class="email"><?php _e('Email:', 'Exemplar'); ?> <a href="mailto:<?php echo $instance['email']; ?>"><?php if($instance['emailtxt']) { echo $instance['emailtxt']; } else { echo $instance['email']; } ?></a></p>
		<?php endif; ?>

		<?php if($instance['web']): ?>
		<p class="web"><?php _e('Web:', 'Exemplar'); ?> <a href="<?php echo $instance['web']; ?>"><?php if($instance['webtxt']) { echo $instance['webtxt']; } else { echo $instance['web']; } ?></a></p>
		<?php endif; ?>
		<?php
		echo $after_widget;
	}
