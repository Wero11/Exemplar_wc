...
class Pyre_Tabs_Widget extends WP_Widget {
	...
	function Pyre_Tabs_Widget()
	{
		...
		$this->WP_Widget('pyre_tabs-widget', 'JadeCreative: Tabs', $widget_ops, $control_ops);
	}
		...
		<div class="tab-holder">
			<div class="tab-hold tabs-wrapper">
				<ul id="tabs" class="tabset tabs">
					...
					<li><a href="#tab1"><?php echo __('Popular', 'Exemplar'); ?></a></li>
					<?php endif; ?>
					<?php if($show_recent_posts == 'true'): ?>
					<li><a href="#tab2"><?php echo __('Recent', 'Exemplar'); ?></a></li>
					<?php endif; ?>
